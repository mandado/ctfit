  ...
  return (
    <Default>
      <div className="flex h-full w-full items-center justify-center bg-gray-50">
        <div className="flex w-12/12 flex-col items-center">
          <h4 className="mb-4 text-3xl font-bold text-gray-700">
            Dicas para começar
          </h4>
          <div className="divide-y divide-gray-200 overflow-y-scroll rounded-lg bg-gray-200 shadow sm:grid sm:grid-cols-3 sm:gap-px sm:divide-y-0">
